...
pub const FAMILY_H_LAYOUT: &[FamilyToken] = &[
    ...
    FamilyToken::new("layout-bg", "var(--semantic-surface-base)"),
    FamilyToken::new("layout-border-color", "var(--semantic-surface-border)"),
    FamilyToken::new("layout-border-width", "1px"),
    FamilyToken::new("layout-scrollbar-size", "var(--space-sm)"),
    FamilyToken::new("layout-scrollbar-bg", "var(--semantic-surface-sunken)"),
    ...
    // Page Header
    FamilyToken::new("page-header-bg", "var(--semantic-surface-base)"),
    ...
    FamilyToken::new("page-header-border", "1px solid var(--semantic-surface-border)"),
    FamilyToken::new("page-header-border-color", "var(--semantic-surface-border)"),
    ...
    FamilyToken::new("page-header-title-fg", "var(--semantic-text-primary)"),
    ...
    FamilyToken::new("page-header-description-fg", "var(--semantic-text-secondary)"),
    ...
    FamilyToken::new("page-header-breadcrumbs-fg", "var(--semantic-text-secondary)"),
    ...
    FamilyToken::new("page-layout-sidebar-bg", "var(--semantic-surface-base)"),
    FamilyToken::new("page-layout-sidebar-border", "1px solid var(--semantic-surface-border)"),
    FamilyToken::new("page-layout-sidebar-padding", "var(--space-md)"),
    FamilyToken::new("page-layout-aside-width", "var(--layout-width-md)"),
    FamilyToken::new("page-layout-aside-bg", "var(--semantic-surface-base)"),
    FamilyToken::new("page-layout-aside-border", "1px solid var(--semantic-surface-border)"),
    FamilyToken::new("page-layout-aside-padding", "var(--space-md)"),

    // Sidebar (has interactive version)
    FamilyToken::new("sidebar-width", "var(--layout-sidebar-width)"),
    FamilyToken::new("sidebar-bg", "var(--semantic-surface-base)"),
    FamilyToken::new("sidebar-border", "1px solid var(--semantic-surface-border)"),
    FamilyToken::new("sidebar-border-color", "var(--semantic-surface-border)"),
    ...
    FamilyToken::new("sidebar-header-border", "1px solid var(--semantic-surface-border)"),
    FamilyToken::new("sidebar-footer-padding", "var(--space-md)"),
    FamilyToken::new("sidebar-footer-border", "1px solid var(--semantic-surface-border)"),
    ...
    FamilyToken::new("sidebar-group-label-fg", "var(--semantic-text-secondary)"),
    ...
    FamilyToken::new("sidebar-separator-color", "var(--semantic-surface-border)"),
    ...
    FamilyToken::new("section-title-color", "var(--semantic-text-primary)"),
    FamilyToken::new("section-title-size", "var(--font-size-2xl)"),
    FamilyToken::new("section-title-weight", "var(--font-weight-bold)"),
    FamilyToken::new("section-description-color", "var(--semantic-text-secondary)"),
    FamilyToken::new("section-description-size", "var(--font-size-sm)"),
    FamilyToken::new("section-description-margin", "var(--space-sm) 0 0 0"),
    FamilyToken::new("section-card-bg", "var(--semantic-surface-base)"),
    FamilyToken::new("section-card-border", "1px solid var(--semantic-surface-border)"),
    FamilyToken::new("section-card-radius", "var(--radius-md)"),
    FamilyToken::new("section-card-shadow", "var(--shadow-sm)"),

    // Separator
    FamilyToken::new("separator-color", "var(--semantic-surface-border)"),
    FamilyToken::new("separator-color-muted", "var(--semantic-surface-sunken)"),
    ...
    FamilyToken::new("block-footer-border", "1px solid var(--semantic-surface-border)"),
    ...
    // Footer
    FamilyToken::new("footer-bg", "var(--semantic-surface-base)"),
    FamilyToken::new("footer-border", "1px solid var(--semantic-surface-border)"),
    ...
    // Header
    FamilyToken::new("header-bg", "var(--semantic-surface-base)"),
    FamilyToken::new("header-border", "1px solid var(--color-border)"),
    ...
    FamilyToken::new("sidebar-menu-item-fg", "var(--semantic-text-primary)"),
    FamilyToken::new("sidebar-menu-item-bg-hover", "var(--semantic-surface-hover)"),
    FamilyToken::new("sidebar-menu-item-bg-active", "var(--semantic-brand-solid)"),
    FamilyToken::new("sidebar-menu-item-fg-active", "var(--color-primary-foreground)"),
    FamilyToken::new("sidebar-menu-item-font-weight-active", "var(--font-weight-medium)"),
    // Aspect Ratio
    FamilyToken::new("aspect-ratio-16-9", "56.25%"),
    FamilyToken::new("aspect-ratio-4-3", "75%"),
