use leptos::prelude::*;
use super::chart_ui::{Chart, ChartData, ChartSeries, ChartKind};
    ...
    ChartData {
        ...
        series: vec![
            ChartSeries {
                ...
                data: vec![42.0, 58.0, 51.0, 73.0, 65.0, 89.0],
                color: None,
            },
            ChartSeries {
                name: "Expenses".to_string(),
                data: vec![31.0, 40.0, 38.0, 52.0, 47.0, 61.0],
                color: None,
            },
        ],
    }
    ...
    ChartData {
        ...
        series: vec![
            ChartSeries {
                ...
                data: vec![120.0, 145.0, 132.0, 178.0, 195.0],
                color: None,
            },
        ],
    }
    ...
    view! {
        <div data-rs-showcase-preview-hero="">
            <div data-rs-showcase-preview-stage="" style="width:100%;">
                <Chart data=monthly_data() chart_type=ChartKind::Line height=280u32 value="revenue-monthly" aria_label="Monthly revenue and expenses line chart" />
            </div>
            ...
            <div data-rs-showcase-preview-section="">
                ...
                <div data-rs-showcase-preview-row="" style="width:100%;">
                    <Chart data=bar_data() chart_type=ChartKind::Bar height=200u32 value="growth-quarterly" aria_label="Quarterly growth bar chart" />
                </div>
            </div>
            <div data-rs-showcase-preview-section="">
                <span data-rs-showcase-preview-label="">"Area"</span>
                <div data-rs-showcase-preview-row="" style="width:100%;">
                    <Chart data=area_data() chart_type=ChartKind::Area height=200u32 value="users-weekly" aria_label="Weekly active users area chart" />
                </div>
            </div>
        </div>
    }
