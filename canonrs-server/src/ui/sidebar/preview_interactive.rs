//! Preview: Sidebar Interactive (default)
//! Demonstra sidebar básica com toggle, header, menu e footer
...
pub fn SidebarPreviewInteractive() -> impl IntoView {
    view! {
        <div data-rs-showcase-preview-anchor="" data-rs-showcase-preview-label="Interactive">
