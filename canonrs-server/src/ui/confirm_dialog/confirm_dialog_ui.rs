use leptos::prelude::*;
use canonrs_core::primitives::dialog::{DialogPrimitive, DialogBackdropPrimitive, DialogPopupPrimitive, DialogHeaderPrimitive, DialogTitlePrimitive, DialogBodyPrimitive, DialogClosePrimitive};
...
#[component]
pub fn ConfirmDialogPreview() -> leptos::prelude::AnyView {
    view! { <ConfirmDialog title="Confirm".to_string() description="Are you sure?".to_string() open=false /> }.into_any()
}
