...
pub fn init(root: Element) {
...

    {
        ...
        let cb = Closure::<dyn Fn(web_sys::MouseEvent)>::new(move |e: web_sys::MouseEvent| {
            ...
            if query::closest(&target, "[data-rs-modal-trigger]") { open(&root_cb); }
        });
...

    {
        ...
        let cb = Closure::<dyn Fn(web_sys::MouseEvent)>::new(move |e: web_sys::MouseEvent| {
            ...
            if query::closest(&target, "[data-rs-modal-overlay]") { close(&root_cb); return; }
            if query::closest(&target, "[data-rs-modal-close]")   { close(&root_cb); }
        });
