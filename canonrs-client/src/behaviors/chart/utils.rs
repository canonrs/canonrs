...
#[cfg(feature = "hydrate")]
pub(crate) fn get_context(canvas: &web_sys::HtmlCanvasElement) -> Option<web_sys::CanvasRenderingContext2d> {
    canvas.get_context("2d").ok()?.and_then(|c| c.dyn_into().ok())
}

#[cfg(feature = "hydrate")]
pub(crate) fn format_axis_val(v: f64) -> String {
...
#[cfg(feature = "hydrate")]
pub(crate) fn dispatch_custom_event(target: &web_sys::Element, name: &str, detail: &js_sys::Object) {
