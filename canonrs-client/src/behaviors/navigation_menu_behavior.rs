...
#[cfg(feature = "hydrate")]
pub fn register() {
    register_behavior("data-navigation-menu", Box::new(|root: &web_sys::Element, _state: &ComponentState| -> BehaviorResult<()> {
        ...
        for i in 0..triggers.length() {
            ...
            let closure = Closure::wrap(Box::new(move |_: web_sys::MouseEvent| {
                ...
                let Ok(content_el) = content.clone().dyn_into::<web_sys::HtmlElement>() else { return; };
