...
use super::{SelectionContext, create_contextual_commands};

#[component]
pub fn TreeTab() -> impl IntoView {
    ...
    view! {
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold mb-2">"Tree + Breadcrumb + Commands"</h2>
                    <p class="text-muted-foreground">"Contextual navigation"</p>
                </div>
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="col-span-2 space-y-6">
                    <div class="border rounded-lg p-6">
                        ...
                        {move || {
                            let ctx = selection_context.get();
                            if ctx.has_selection() {
                                view! {
                                    <div class="space-y-3">
                                        <div>
                                            <span class="text-sm text-muted-foreground">"Type: "</span>
                                            <code class="text-sm">{ctx.node_type.unwrap_or_default()}</code>
                                        </div>
                                    </div>
                                }.into_any()
                            } else {
                                view! { <p class="text-muted-foreground">"Select a node"</p> }.into_any()
                            }
                        }}
                    </div>
