...
pub const DATA_TOKENS: &[FamilyToken] = &[
    ...
    FamilyToken::new("table-row-bg-hover",         "var(--theme-surface-muted)"),
        FamilyToken::new("table-row-bg-selected",        "color-mix(in srgb, var(--theme-action-primary-bg) 15%, transparent)"),
    ...
    FamilyToken::new("table-row-bg-editing",  "color-mix(in srgb, var(--theme-action-accent-bg) 12%, transparent)"),
    FamilyToken::new("table-row-border-editing", "var(--theme-action-accent-bg)"),
    FamilyToken::new("table-row-bg-deleting", "color-mix(in srgb, var(--theme-action-destructive-bg, #ef4444) 12%, transparent)"),
    FamilyToken::new("table-row-border-deleting", "var(--theme-action-destructive-bg, #ef4444)"),
    FamilyToken::new("table-expand-row-bg",       "var(--theme-surface-muted)"),
    FamilyToken::new("table-expand-row-padding",  "var(--space-md)"),
    FamilyToken::new("table-expand-btn-size",     "var(--space-lg)"),
    FamilyToken::new("table-expand-btn-color",    "var(--theme-surface-fg)"),
    FamilyToken::new("table-col-min-width",          "40px"),
    FamilyToken::new("table-resize-handle-width",   "4px"),
    FamilyToken::new("table-resize-handle-color",   "var(--theme-action-primary-bg)"),
    FamilyToken::new("table-resize-handle-opacity", "0.4"),
    FamilyToken::new("table-resize-handle-opacity-active", "0.8"),
    FamilyToken::new("table-resize-handle-z",       "2"),
