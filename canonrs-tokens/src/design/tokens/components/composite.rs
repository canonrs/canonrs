...
pub const COMPOSITE_TOKENS: &[FamilyToken] = &[
    ...
    FamilyToken::new("carousel-button-shadow",         "0 4px 12px rgba(0,0,0,0.4)"),
    FamilyToken::new("carousel-button-bg",             "var(--theme-overlay-bg)"),
    FamilyToken::new("carousel-button-bg-hover",        "var(--theme-overlay-heavy-bg)"),
    FamilyToken::new("carousel-button-shadow-hover",    "var(--shadow-xl)"),
    FamilyToken::new("carousel-button-size",           "3rem"),
