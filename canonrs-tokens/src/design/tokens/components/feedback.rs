...
pub const FEEDBACK_TOKENS: &[FamilyToken] = &[
    ...
    FamilyToken::new("alert-border-color-default",    "var(--theme-surface-border)"),
    FamilyToken::new("alert-border-color-info",       "var(--color-info)"),
    FamilyToken::new("alert-border-color-success",    "var(--color-success)"),
    FamilyToken::new("alert-border-color-warning",    "var(--color-warning)"),
    FamilyToken::new("alert-border-color-error",      "var(--color-destructive)"),
    ...
    FamilyToken::new("callout-bg-default", "color-mix(in srgb, var(--theme-surface-border) 30%, transparent)"),
    FamilyToken::new("callout-bg-info", "color-mix(in srgb, var(--theme-state-info-bg) 15%, transparent)"),
    FamilyToken::new("callout-bg-success", "color-mix(in srgb, var(--theme-state-success-bg) 15%, transparent)"),
    FamilyToken::new("callout-bg-warning", "color-mix(in srgb, var(--theme-state-warning-bg) 15%, transparent)"),
    FamilyToken::new("callout-bg-error", "color-mix(in srgb, var(--theme-state-error-bg) 15%, transparent)"),
    ...
    FamilyToken::new("inline-notice-padding-y", "var(--space-xs)"),
    ...
    FamilyToken::new("inline-notice-bg-info", "color-mix(in srgb, var(--theme-state-info-bg) 12%, transparent)"),
    FamilyToken::new("inline-notice-bg-success", "color-mix(in srgb, var(--theme-state-success-bg) 12%, transparent)"),
    FamilyToken::new("inline-notice-bg-warning", "color-mix(in srgb, var(--theme-state-warning-bg) 12%, transparent)"),
    FamilyToken::new("inline-notice-bg-error", "color-mix(in srgb, var(--theme-state-error-bg) 12%, transparent)"),
    FamilyToken::new("inline-notice-fg", "var(--theme-surface-fg)"),
    FamilyToken::new("inline-notice-font-size", "var(--font-size-xs)"),
