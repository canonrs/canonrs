...
pub const SELECTION_TOKENS: &[FamilyToken] = &[
    ...
    FamilyToken::new("tree-item-bg-active", "color-mix(in srgb, var(--theme-action-accent-bg) 18%, transparent)"),
    FamilyToken::new("tree-item-active-indicator", "var(--theme-action-primary-bg)"),
    FamilyToken::new("tree-guide-color", "color-mix(in srgb, var(--theme-surface-fg) 12%, transparent)"),
