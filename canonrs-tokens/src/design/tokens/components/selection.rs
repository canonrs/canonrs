...
// Components: Selection — Accordion, Combobox, ContextMenu, Menu, Menubar, Tree, Command, Checkbox, Radio, Tabs
...
pub const SELECTION_TOKENS: &[FamilyToken] = &[
    ...
    FamilyToken::new("collapsible-trigger-fg-open", "var(--theme-action-primary-bg)"),
    ...
    FamilyToken::new("tree-item-height", "1.75rem"),
    ...
    FamilyToken::new("tree-indent-depth-2", "calc(var(--space-lg) + var(--space-md))"),
    FamilyToken::new("tree-item-bg-hover", "var(--theme-action-secondary-bg)"),
    FamilyToken::new("tree-item-bg-selected", "color-mix(in srgb, var(--theme-action-accent-bg) 12%, transparent)"),
    FamilyToken::new("tree-item-bg-active", "color-mix(in srgb, var(--theme-action-accent-bg) 25%, transparent)"),
    FamilyToken::new("tree-item-bg-focus", "color-mix(in srgb, var(--theme-surface-fg) 8%, transparent)"),
    ...
    FamilyToken::new("command-empty-padding", "var(--space-md)"),
    FamilyToken::new("command-padding", "0"),
    FamilyToken::new("command-gap", "0"),
    FamilyToken::new("command-separator-color", "var(--theme-surface-border)"),
    FamilyToken::new("command-separator-margin-y", "var(--space-xs)"),
    FamilyToken::new("command-empty-fg", "var(--theme-surface-fg-muted)"),
