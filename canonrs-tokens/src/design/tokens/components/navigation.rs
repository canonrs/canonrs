...
pub const NAVIGATION_TOKENS: &[FamilyToken] = &[
    ...
    FamilyToken::new("sidebar-menu-item-fg-active", "var(--theme-action-accent-fg)"),
    ...
    FamilyToken::new("navigation-menu-trigger-fg-active", "var(--theme-action-accent-fg)"),
    ...
    FamilyToken::new("link-group-label-letter-spacing", "0.05em"),
