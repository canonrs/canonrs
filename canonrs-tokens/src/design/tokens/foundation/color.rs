...
pub const FOUNDATION_COLOR: &[FamilyToken] = &[
    ...
    FamilyToken::new("color-primary-alpha-10",    "hsl(var(--primitive-primary-h) var(--primitive-primary-s) var(--primitive-primary-l) / 0.10)"),
    FamilyToken::new("color-primary-alpha-12",    "hsl(var(--primitive-primary-h) var(--primitive-primary-s) var(--primitive-primary-l) / 0.12)"),
    FamilyToken::new("color-primary-alpha-18",    "hsl(var(--primitive-primary-h) var(--primitive-primary-s) var(--primitive-primary-l) / 0.18)"),
