...
pub fn scan_all() {
    ...
    let selector = "[data-rs-table],[data-rs-tooltip],[data-rs-collapsible],[data-rs-switch],[data-rs-toggle],[data-rs-checkbox],[data-rs-alert],[data-rs-banner],[data-rs-button],[data-rs-doc-progress],[data-rs-icon-button],[data-rs-input-group],[data-rs-input-otp],[data-rs-menu],[data-rs-navigation-menu],[data-rs-toast],[data-rs-toc]";
